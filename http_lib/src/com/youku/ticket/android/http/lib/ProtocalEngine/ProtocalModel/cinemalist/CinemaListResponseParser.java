...
/**
 * @className CinemaListResponseParser
 * @description 影院列表响应解析器
 * @author LLC
 * @date 2014-12-25 上午11:01:41
 */
public class CinemaListResponseParser extends ResponseParserBase {
    ...
    private CinemaListResponseData responseData = new CinemaListResponseData();
