...
/**
 * @className CinemaListRequestProtocol
 * @description 影院列表请求协议构造器
 * @author LLC
 * @date 2014-12-22 下午6:09:46
 */
public class CinemaListRequestProtocol extends RequestProtocolBase {

    @Override
    public String getUrl() {
        return super.getUrl() + "v1/base/cinema/cinema_list.json" + getRequestGetData();
    }
    ...
    private String getRequestGetData() {
        CinemaListRequestData requestData = (CinemaListRequestData) getObj();
        ...
        //城区Id
        if (requestData.getDistrictId() != -1) {
            sb.append("&");
            sb.append("districtId");
            sb.append("=");
            sb.append(requestData.getDistrictId());
        }

        //影片Id
        if (requestData.getPromId() != -1) {
            sb.append("&");
            sb.append("promId");
            sb.append("=");
        ...
        //排列方式
        if (requestData.getSortType() != -1) {
            sb.append("&");
            sb.append("sortType");
            sb.append("=");
            sb.append(requestData.getSortType());
        }
