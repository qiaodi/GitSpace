...
public class CinemaListFragmentSales extends CinemaListFragmentBase {
    @Override
    public void onCreate(Bundle savedInstanceState) {
        // TODO Auto-generated method stub
        super.onCreate(savedInstanceState);
        mAdapter = new CinemaListAdapterBase(getActivity(), CinemaListDataType.SALES, mTargetMovie);
