...
public class MyLocationManager {
    ...
    LocationListener[] mLocationListeners = new LocationListener[] { new LocationListener(android.location.LocationManager.GPS_PROVIDER),
    ...
    private void startReceivingLocationUpdates() {
        ...
        if (mLocationManager != null) {
            try {
            	try {
            		mLocationManager.requestLocationUpdates(android.location.LocationManager.NETWORK_PROVIDER, 1000, 0F, mLocationListeners[1]);
				} catch (Exception e) {
            ...
            try {
            	try {
            		mLocationManager.requestLocationUpdates(android.location.LocationManager.GPS_PROVIDER, 1000, 0F, mLocationListeners[0]);
        ...
        public void onStatusChanged(String provider, int status, Bundle extras) {
            switch (status) {
                ...
                case LocationProvider.TEMPORARILY_UNAVAILABLE: {
                    mValid = false;
                    if (mListener != null && mRecordLocation && android.location.LocationManager.GPS_PROVIDER.equals(provider)) {
